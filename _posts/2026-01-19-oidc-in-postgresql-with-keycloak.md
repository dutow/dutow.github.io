...
tags: ['PostgreSQL', 'OIDC', 'Security', 'Keycloak']
image: /assets/img/blog/2025/11/oidc2.png
excerpt: "After two posts on OAuth/OIDC theory, a practical walkthrough: configuring PostgreSQL with Keycloak and pg_oidc_validator end-to-end, from certificates and hostnames through realms, clients, scopes, and the pg_hba/pg_ident setup."
---

> *Originally published on the [Percona Community blog](https://percona.community/blog/2026/01/19/oidc-in-postgresql-with-keycloak/).*

We spent a long time, [two](/blog/oauth-oidc-validators/) blog [posts](/blog/oidc-in-postgresql/) to be specific, talking about OAuth/OIDC in theory.
...
![Creating a new realm in Keycloak](/assets/img/blog/2026/01/keycloak_step1_realm.png)
...
![Creating a user in Keycloak](/assets/img/blog/2026/01/keycloak_step2_user.png)
...
![Setting user credentials in Keycloak](/assets/img/blog/2026/01/keycloak_step3_user.png)
...
![Creating a client in Keycloak](/assets/img/blog/2026/01/keycloak_step4_client.png)
...
![Configuring client authentication flow in Keycloak](/assets/img/blog/2026/01/keycloak_step5_client.png)
...
![Configuring consent screen in Keycloak](/assets/img/blog/2026/01/keycloak_step6_client.png)
...
![Creating a client scope in Keycloak](/assets/img/blog/2026/01/keycloak_step7_scope.png)
