...
image: /assets/img/blog/2025/11/oidc1.jpg
excerpt: "Somebody might tell you, \"let's configure PostgreSQL 18 with OIDC, it should be simple, only takes a few minutes!\" That might be true if you already have a provider set up - or it might take much longer if you start with \"What is this OIDC stuff about?\""
---

> *Originally published on the [Percona Community blog](https://percona.community/blog/2025/11/07/oauth-oidc-validators/).*
