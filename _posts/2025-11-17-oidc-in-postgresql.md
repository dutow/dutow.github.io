...
excerpt: "How OIDC actually works in PostgreSQL, what OAuthBearer is about, and the attacks and dangers in this flow - showcasing why a properly configured secure provider matters and why users shouldn't skim through the authorization process."
---

> *Originally published on the [Percona Community blog](https://percona.community/blog/2025/11/17/oidc-in-postgresql-how-it-works-and-staying-secure/).*

In the previous blog post about the topic, [OAuth, OIDC and validators](/blog/oauth-oidc-validators/), we discussed basic terminologies to understand the differences between the protocols and how they relate to PostgreSQL.
