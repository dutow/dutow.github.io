...
tags: ['PostgreSQL', 'OIDC', 'Security']
image: /assets/img/blog/2026/04/oidc-errors.png
excerpt: "Following the Keycloak demo setup, we explore how OAuth keeps PostgreSQL servers secure - not through complex attacks, but through practical errors, misconfigurations, and honest mistakes. Understanding error messages and how to fix them."
---

> *Originally published on the [Percona Community blog](https://percona.community/blog/2026/04/30/oidc-error-scenarios/).*

Last time, in [OIDC in PostgreSQL: With Keycloak](/blog/oidc-in-postgresql-with-keycloak/), we created a working demo setup that was able to successfully authenticate a user using OIDC.
...
We won't focus on complex attack vectors, like the examples in the [second blog post](/blog/oidc-in-postgresql/) in the OIDC series.
